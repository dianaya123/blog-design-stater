...
// Mengambil artikel technology terbaru
...
// Mengambil artikel trending technology
...
<head>
    ...
    <title>Artikel Technology</title>
...
<body>
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="technology.php" class="active">Technology</a></li>
    ...
    <div class="container">
        <div class="main-content">
            <h1>Artikel Technology Terbaru</h1>
            <?php
            if ($result->num_rows > 0) {
                ...
                echo "<div class='post'><p>Tidak ada artikel technology saat ini.</p></div>";
            }
            ?>
